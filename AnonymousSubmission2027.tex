...
\begin{figure*}[h!]
    ...
    \caption{The three properties ALPS combines - objective scoring, renewability, and creative construction - shown as three overlapping regions. Each family achieves at most two: static problem sets such as MATH, code, and miniF2F \citep{hendrycks2021measuring, chen2021evaluating, zheng2021minif2f} are scored and demand construction but contaminate; synthetic puzzles such as random SAT and the Equational Theories Project \citep{selman1996generating, bolan2025equational} are scored and renewable but follow a known procedure; open scientific discovery such as hypothesis generation and molecule design \citep{gottweis2026accelerating, jumper2021highly} constructs and renews but is judged subjectively. Only ALPS lies in the intersection of all three.}
...
\begin{figure*}[h!]
    \centering
    \includegraphics[width=1.0\linewidth]{Figures/ALPS_Methodology_b.pdf}
    \caption{Methodology Figure - placeholder caption}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1.0\linewidth]{Figures/ALPS_Methodology_a.pdf}
    \caption{Methodology Figure 2 - placeholder caption}
    \label{fig:methodology}
\end{figure}
